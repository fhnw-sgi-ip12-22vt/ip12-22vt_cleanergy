...
public interface ViewMixin<M, C extends ControllerBase<M>> extends Projector<M, C> {
   ...
   * @return a 'Converter' to specify a function converting the type of 'ObservableValue' into the
  ...
  record Converter<V>(ObservableValue<V> observableValue) {
     ...
     *
     * @param converter the function converting the type of 'ObservableValue' into the type of the
     *                  'Property'
    ...
    /**
     * Registers an observer without any type conversion that will keep property-value and
     * observableValue in sync.
     *
  ...
  record Updater<V, P>(ObservableValue<V> observableValue, Function<V, P> converter) {
    ...
    /**
     * Registers an observer that will keep observableValue and GUI-Property in sync by applying the
     * specified converter.
     *
     * @param property GUI-Property that will be updated when observableValue changes
     */
